-- Layer: Silver
-- Description: Clean and standardize market impact data from the Bronze layer
-- Source: cyber_bronze.market_impact

CREATE OR REPLACE TABLE `cyberproject-488907.cyber_silver.market_impact_clean` AS
WITH src AS (
  SELECT *
  FROM `cyberproject-488907.cyber_bronze.market_impact`
)
SELECT
